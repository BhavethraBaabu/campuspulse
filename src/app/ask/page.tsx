...
function AskChat() {
  ...
  const exportToPDF = () => {
    ...
    const html = `
      ...
      <div class="footer">Generated by CampusPulse Clark · Tech Innovation Challenge 2026</div>
      </body></html>`;
                    ...
                    {msg.role === "user" ? (
                      ...
                      <div className="px-4 py-4 rounded-2xl rounded-tl-sm"
                        ...
                        <div className="flex gap-1.5 items-center">
                          <span className="text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>Searching Clark's website</span>
                          {[0, 0.2, 0.4].map((d, i) => (
    ...
    <div className="px-3 py-2 text-xs"
      ...
      📌 Clark University · Worcester, MA 01610
                        ...
                        <div className="flex items-center gap-3 mt-2 ml-1 flex-wrap">
                          ...
                          {msg.helpful === false && <span className="text-xs text-red-400/60">Thanks, we'll improve.</span>}
        ...
        <div className="flex-shrink-0 px-4 py-4 max-w-3xl mx-auto w-full">
          <div className="relative flex items-end gap-2 p-2 rounded-2xl"
            ...
            <textarea ref={inputRef} value={input} onChange={e => setInput(e.target.value)}
              ...
              placeholder={listening ? "Listening..." : "Ask anything about Clark University..."}
